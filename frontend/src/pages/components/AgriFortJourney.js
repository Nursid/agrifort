...
//             <h2 className="text-3xl md:text-4xl font-heading mb-6" style={{ color: primaryDark }}>
//               AgriFort <span className="text-[#1c5517] font-heading text-3xl md:text-4xl">Journey</span>
//             </h2>
//           </header>
  ...
  return (
    <div className="min-h-screen font-sans text-white">
      ...
      <div className="relative w-full h-[300px] md:h-[500px] overflow-hidden">
        <img 
          src="/images/breadcrum/journey.jpeg" 
      ...
      <div className="bg-[#57488E] px-6 py-12 md:px-20 lg:px-40">
        <div className="max-w-5xl mx-auto space-y-8 text-sm md:text-base leading-relaxed opacity-90">
          
          <p data-aos="fade-up" className='text-justify hyphens-auto' >
            AgriFort Technologies was born from a vision at Blue Quadrant, Dubai—to build a strong, 
            future-ready agriculture company, and what better place to begin this journey than in 
            the heart of Indian farming. What started as a single idea has today grown into one of the 
          ...
          <p data-aos="fade-up"  className='text-justify hyphens-auto'>
            ...
            to increase yields and enhance farm income. Over the years, our journey has expanded beyond 
            agriculture into a robust ecosystem of companies: <strong>BlueFort Healthcare</strong> in the pharmaceutical sector, 
            <strong>Vetsburg</strong> in veterinary sector, <strong>Sutantra</strong> in information technology, 
            <strong>AgriFort Sciences</strong> as our dedicated research and development arm, <strong>Geekay</strong> as our 
            manufacturing unit and <strong>AgriFort Seedex</strong>, registered for our future seed innovation endeavours. 
            Together, they represent our belief in building a group that solves real problems across 
            agriculture, health and technology—strengthening the lives of people we serve.
          </p>

          <p data-aos="fade-up"  className='text-justify hyphens-auto'>
            With a wide range of eco-friendly and cost-effective products, a distribution network that 
            reaches the deepest pockets of India, and global collaborations supporting our growth, we 
            have earned the trust of millions of farmers who consistently share exceptional results 
            on the field. Their success stories inspire us daily and validate the science and passion 
            behind everything we create.
          </p>

          <p  data-aos="fade-up"  className='text-justify hyphens-auto pt-4'> 
            As an organisation, we remain committed to society and every stakeholder—working responsibly, 
            innovating relentlessly and striving to bring more smiles to the farmer's face. For us, the 
            philosophy is simple and eternal: <span className="italic font-semibold text-lg">when farmers win – we win.</span>
          </p>
