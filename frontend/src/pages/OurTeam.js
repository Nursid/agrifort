    ...
    const teamMembers = [
        {
            ...
            image: '/images/img/team-1-800x800.jpg',
        ...
        },
        {
            ...
            department: 'rd',
            image: '/images/img/team-2-800x800.jpg',
        ...
        },
        {
            ...
            department: 'sales',
            image: '/images/img/team-3-800x800.jpg',
        ...
        },
        {
            ...
            department: 'rd',
            image: '/images/img/team-4-470x470.png',
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="space-y-6" data-aos="fade-left">
                            ...
                            <p className="text-xl text-gray-700 leading-relaxed">
                                AgriFort's leadership team consists of accomplished professionals with extensive expertise 
                                in agriculture, biotechnology, and business management. Their strategic guidance fuels innovation, 
                                drives success, and contributes to AgriFort's unwavering commitment to excellence in 
                                sustainable agricultural solutions.
                            </p>
                            <div className="flex flex-wrap gap-4 pt-4">
                                <div className="flex items-center gap-2 bg-green-100 px-4 py-2 rounded-full">
                                    <span className="text-green-600 text-2xl">✓</span>
                                    <span className="text-green-800 font-medium">Expert Leadership</span>
                                </div>
                                <div className="flex items-center gap-2 bg-green-100 px-4 py-2 rounded-full">
                                    <span className="text-green-600 text-2xl">✓</span>
                                    <span className="text-green-800 font-medium">Diverse Expertise</span>
                                </div>
                                <div className="flex items-center gap-2 bg-green-100 px-4 py-2 rounded-full">
                                    <span className="text-green-600 text-2xl">✓</span>
                                    <span className="text-green-800 font-medium">Proven Track Record</span>
                                </div>
                            </div>
                        </div>
                    </div>
