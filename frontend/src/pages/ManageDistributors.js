...
const ManageDistributors = () => {
    ...
    return (
        <div className="p-6">
            ...
            <div className="mb-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Manage Distributor</h1>
                        <p className="text-gray-600 mt-1">Manage Distributor</p>
                    </div>
      ...
      <ModalWrapper 
        ...
        title={editingUser ? 'Edit Distributor' : 'Add New Distributor'}
      >
