                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-4 bg-black rounded-lg p-4">
                        ...
                        <p className="text-white text-sm leading-relaxed">
                            Leading agro-biotech company dedicated to empowering farmers with innovative, 
                            sustainable agricultural solutions for better harvests and a greener future.
                        </p>
                        ...
                        <div className="flex gap-3 pt-4">
                            <a
                                ...
                                className="w-10 h-10 rounded-lg flex items-center justify-center transition-all duration-200 hover:scale-110 hover:bg-green-500"
                        ...
                        <ul className="space-y-2">
                            <li>
                                <button 
                                    ...
                                    className="text-white text-sm hover:text-green-300 transition-colors duration-200 text-left w-full"
                                >
                                    About AgriFort
                                </button>
                            </li>
                            ...
                            <li>
                                <button 
                                    onClick={() => console.log('Navigate to sustainability')}
                                    className="text-white text-sm hover:text-green-300 transition-colors duration-200 text-left w-full"
                                >
                                    Sustainability
                                </button>
                    ...
                    <div className="space-y-4">
                        <h5 className="text-white font-bold text-lg mb-4">Customer Support</h5>
                        <ul className="space-y-2">
                            <li>
                                <button 
                            ...
                            <li>
                                <button 
                                    onClick={() => console.log('Navigate to helpdesk')}
                                    className="text-white text-sm hover:text-green-300 transition-colors duration-200 text-left w-full"
                                >
                                    Technical Helpdesk
                                </button>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="pt-4">
                            <p className="text-white font-semibold text-sm mb-3">Subscribe to AgriFort Insights</p>
                            <div className="flex gap-0">
                                <input
                                    type="email"
                                    placeholder="Enter email"
                                    className="flex-1 px-3 py-2 rounded-l-lg text-gray-900 text-sm border-0 focus:outline-none focus:ring-2 focus:ring-green-400"
                                />
                                <button
                                    className="px-4 py-2 rounded-r-lg text-white font-bold transition-all duration-200 hover:scale-105"
